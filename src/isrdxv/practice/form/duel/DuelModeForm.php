...
class DuelModeForm extends MenuForm
{
    ...
    function __construct(bool $ranked = false)
    {
        ...
        foreach($kits as $kit) {
            ...
            $options[] = new MenuOption(TextFormat::AQUA . $kit->getName() . TextFormat::EOL . QueueHandler::getInstance()->getPlayersOfKit($kit->getName(), $ranked) . " Queuing..." . TextFormat::EOL . TextFormat::GRAY . "Click to Play!", new FormIcon($kit->getDataInfo()->icon, FormIcon::IMAGE_TYPE_PATH));
        }
