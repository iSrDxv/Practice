...
final class ItemManager
{
  ...
  static function init(): void
  {
    ...
    self::register(8, self::LEAVE_QUEUE, VanillaItems::DYE()->setColor(DyeColor::RED())->setCustomName(TextFormat::BOLD . TextFormat::DARK_GRAY . "» " . TextFormat::RESET . Practice::SERVER_COLOR . "Leave Queue" . TextFormat::RESET . TextFormat::BOLD . TextFormat::DARK_GRAY . " «"));
    self::register(8, self::PROFILE, VanillaBlocks::MOB_HEAD()->setMobHeadType(MobHeadType::PLAYER())->asItem()->setCustomName(TextFormat::BOLD . TextFormat::DARK_GRAY . "» " . TextFormat::RESET . Practice::SERVER_COLOR . "Player Menu" . TextFormat::RESET . TextFormat::BOLD . TextFormat::DARK_GRAY . " «"));
  }
