...
final class ItemManager
{
  ...
  static function init(): void
  {
    ...
    self::register(5, self::SPECTATE, VanillaItems::BOOK()->setCustomName(TextFormat::BOLD . TextFormat::DARK_GRAY . "» " . TextFormat::RESET . Practice::SERVER_COLOR . "Spectator Menu" . TextFormat::RESET . TextFormat::BOLD . TextFormat::DARK_GRAY . " «"));
